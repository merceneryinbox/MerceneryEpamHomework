...
public class JSE01Task05 {
	...
	/**
	 * Class BlockNote stores in itself Map<EntryNote, String> </EntryNote,> where String is - entry of EntryNote
	 * class.
	 */
	public static class BlockNote {
		...
		/**
		 * @param editEntryNote throw new IOException("Error in editing entry " + editEntryNote + " try again, " + e)
		 *                      with my comments
		 */
