...
public class NuclearSubmarine {
	...
	public static void main(String[] args) {
		...
		NuclearSubmarine.AtomicSubmarineMemberInnerDrive memberDrive =
				new NuclearSubmarine("2").new AtomicSubmarineMemberInnerDrive();
		...
		NuclearSubmarine                                 nuclearSubmarine2 =
				new NuclearSubmarine("\nNuclear sub for test outer class method " + "creation of inner member class");
		NuclearSubmarine.AtomicSubmarineMemberInnerDrive localDrive        =
				nuclearSubmarine2.extractMyInnerMemberDrive();
		...
		NuclearSubmarine.AtomicSubmarineMemberInnerDrive innerMemberDrive6 =
				nuclearSubmarine6.new AtomicSubmarineMemberInnerDrive();
		System.out.println();
	...
	public void testInnerLocal() {
		...
		class InnerLocalClass {
			...
			void testOuterVarsAndMethodsAccess() {
				...
				System.out.println(
						"Test for inner local access for outer static methods " + staticOuterStartEngineMethod());
				System.out.println(
						"Test for inner local access for outer not static vars " + notStaticStartEngineMethod());
			}
		}
